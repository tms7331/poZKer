...
class PoZKerApp extends o1js__WEBPACK_IMPORTED_MODULE_0__/* .SmartContract */ .C3 {
    init() {
        ...
        const pot = o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt32 */ .xH.from(0);
        const lastBetSize = o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt32 */ .xH.from(0);
        ...
        this.slot2.set((0,o1js__WEBPACK_IMPORTED_MODULE_0__/* .Field */ .gN)(239414220863));
    }
    joinGame(player) {
    ...
    getGamestate() {
        ...
        const gameOver = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Provable */ .PC.if(gameOverLastBetSize.greaterThanOrEqual(o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt32 */ .xH.from(1000)), this.GameOver, this.GameNotOver);
    ...
    setGamestate(stack1, stack2, turn, street, lastAction, lastBetSize, gameOver, pot) {
        ...
        const gameOverLastBetSize = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Provable */ .PC.if(gameOver.equals(this.GameNotOver), lastBetSize, lastBetSize.add(o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt32 */ .xH.from(1000)));
    ...
    playerTimeout() {
        ...
        const newPot = o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt32 */ .xH.from(0);
        // TODO - fix this!
        const newLastBetSize = o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt32 */ .xH.from(0);
    ...
    withdraw() {
        ...
        pot.equals(o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt32 */ .xH.from(0)).assertTrue("Pot has not been awarded!");
        const player1Hash = this.player1Hash.getAndRequireEquals();
        const player2Hash = this.player2Hash.getAndRequireEquals();
        const player = this.sender;
        const playerHash = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Poseidon */ .jm.hash(player.toFields());
    ...
    deposit(depositAmount) {
        ...
        const stack1New = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Provable */ .PC.if(playerHash.equals(player1Hash), depositAmount.sub(this.SmallBlind), stack1);
        const stack2New = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Provable */ .PC.if(playerHash.equals(player2Hash), depositAmount.sub(this.BigBlind), stack2);
        const potNew = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Provable */ .PC.if(playerHash.equals(player1Hash), pot.add(this.SmallBlind), pot.add(this.BigBlind));
        // Set last bet to be 1 to make the math work out?
        const newLastBetSize = o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt32 */ .xH.from(1);
    ...
    takeAction(action, betSize) {
        ...
        const actionReal = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Provable */ .PC.if(action.equals(this.Call).and(pot.equals(o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt32 */ .xH.from(3))), this.PreflopCall, action);
        // Amount checks/logic:
        ...
        const compareStack = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Provable */ .PC.if(p1turn, stack1, stack2);
        ...
        const potNew = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Provable */ .PC.if(gameOverNow.equals(this.GameOver), o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt32 */ .xH.from(0), pot.add(betSizeReal));
        // TODO - double check logic - any other scenarios we should reset lastBetSize?
        const newLastBetSize = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Provable */ .PC.if(actionReal.equals(this.Call), o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt32 */ .xH.from(0), betSizeReal);
    ...
    showdown() {
        ...
        const tieAdj = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Provable */ .PC.if((0,o1js__WEBPACK_IMPORTED_MODULE_0__/* .Bool */ .tW)(slot0 === slot1), // pot should always be evenly divisible by 2
        pot.div(o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt32 */ .xH.from(2)), o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt32 */ .xH.from(0));
        ...
        const potNew = o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt32 */ .xH.from(0);
    ...
    storeHardcodedCards() {
        ...
        const shuffleSecret = o1js__WEBPACK_IMPORTED_MODULE_0__/* .PrivateKey */ ._q.fromBigInt(BigInt(1));
        // Ah
        const cardPoint1F = o1js__WEBPACK_IMPORTED_MODULE_0__/* .PublicKey */ .nh.fromBase58("B62qoa5ohnNnFEXfbPshXCzkBkgWSzXk3auy2yS9hyjLma4EkH7xWbs").toFields()[0];
        // Ad
        const cardPoint2F = o1js__WEBPACK_IMPORTED_MODULE_0__/* .PublicKey */ .nh.fromBase58("B62qiuLMUJ9xPCYGqAzJY2C8JTwgAFhfgZFTnVRsq3EBksHKAE1G3mX").toFields()[0];
        // Ks
        const cardPoint3F = o1js__WEBPACK_IMPORTED_MODULE_0__/* .PublicKey */ .nh.fromBase58("B62qnp98SGKe6dQ2cTMUKJeWGhECfj57vZGS5D5MA9hr5bXFYMo3wDM").toFields()[0];
        // Ts
        const cardPoint4F = o1js__WEBPACK_IMPORTED_MODULE_0__/* .PublicKey */ .nh.fromBase58("B62qrdxHXHyuQjDSyYPsWYTEgtZBSEqF5bpTktk5RqSwbdojebLVZLH").toFields()[0];
    ...
    constructor(){
        ...
        this.MinBuyin = o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt32 */ .xH.from(20);
        this.MaxBuyin = o1js__WEBPACK_IMPORTED_MODULE_0__/* .UInt32 */ .xH.from(200);
