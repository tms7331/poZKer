...
export default function Component() {
  ...
  let loadingContent = <h3>Loading contracts, please wait for contracts to load!</h3>;
  let mainContent;
  if (globalState.hasBeenSetup && globalState.accountExists) {
    loadingContent = <h1></h1>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container flex flex-col items-center justify-center space-y-4 text-center px-4 md:px-6">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">Welcome to poZKer</h1>
