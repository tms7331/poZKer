...
export default function Component() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      if (
        player === "0" &&
        (pkrState.handStage === "2" || pkrState.handStage === "3")
      ) {
        const seatI = "0";
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      if (
        player === "1" &&
        (pkrState.handStage === "3" || pkrState.handStage === "4")
      ) {
        const seatI = "1";
        const cards = await fetchAPICards(pkrState.handId, seatI, "holeCards");
        setHolecard0(cards[0]!);
        ...
        if (playerI == pkrState.playerTurn) {
          ...
          if (lastActionStr === "Null" || lastActionStr === "Check") {
            ...
            const betDiff = Math.abs(
              Number(pkrState.betThisStreet1) - Number(pkrState.betThisStreet0),
            );
            ...
            <div className="poker-board mx-auto flex w-full flex-1 flex-col justify-between overflow-hidden rounded-[50%/200px] border-4 border-[#000201] px-[5px] py-8 md:rounded-[40%/300px] lg:h-[calc(100dvh-56px-136px)] 2xl:rounded-[60%/500px] 2xl:py-12">
              <div className="flex flex-col gap-2">
                ...
                <div className="mx-auto flex w-fit min-w-[60px] gap-1 rounded-full bg-black/60 px-3 py-2 text-center text-white">
                  ...
                  />{" "}
                  <span className="font-semibold">{oppBetThisStreet}</span>
                </div>
              </div>
              <div className="flex flex-col gap-2 lg:gap-2.5">
                <section className="mx-auto flex w-full max-w-[536px] justify-center gap-2">
                  {boardcard0SVG === "/svg_playing_cards/backs/blue.svg" ? (
                    <div className="my-auto h-[89.64px] w-full max-w-[63px] rounded-md border-[3px] border-gray-800 border-opacity-75 sm:h-[128.06px] sm:max-w-[90px] lg:h-[142.3px] lg:max-w-[100px]"></div>
                  ) : (
                    <Image
                  ...
                  {boardcard1SVG === "/svg_playing_cards/backs/blue.svg" ? (
                    <div className="my-auto h-full w-full max-w-[63px] rounded-md border-[3px] border-gray-800 border-opacity-75 sm:max-w-[90px] lg:max-w-[100px]"></div>
                  ) : (
                    <Image
                      className="my-auto h-fit max-w-[63px] sm:max-w-[90px] lg:max-w-[100px]"
                      src={boardcard1SVG}
                  ...
                  {boardcard2SVG === "/svg_playing_cards/backs/blue.svg" ? (
                    <div className="my-auto h-full w-full max-w-[63px] rounded-md border-[3px] border-gray-800 border-opacity-75 sm:max-w-[90px] lg:max-w-[100px]"></div>
                  ) : (
                    <Image
                      className="my-auto h-fit max-w-[63px] sm:max-w-[90px] lg:max-w-[100px]"
                  ...
                  {boardcard3SVG === "/svg_playing_cards/backs/blue.svg" ? (
                    <div className="my-auto h-full w-full max-w-[63px] rounded-md border-[3px] border-gray-800 border-opacity-75 sm:max-w-[90px] lg:max-w-[100px]"></div>
                  ) : (
                    <Image
                      className="my-auto h-fit max-w-[63px] sm:max-w-[90px] lg:max-w-[100px]"
                  ...
                  {boardcard4SVG === "/svg_playing_cards/backs/blue.svg" ? (
                    <div className="my-auto h-full w-full max-w-[63px] rounded-md border-[3px] border-gray-800 border-opacity-75 sm:max-w-[90px] lg:max-w-[100px]"></div>
                  ) : (
                    <Image
                      className="my-auto h-fit max-w-[63px] sm:max-w-[90px] lg:max-w-[100px]"
              ...
              <div className="flex flex-col gap-2">
                <div className="mx-auto flex w-fit min-w-[60px] gap-1 rounded-full bg-black/60 px-3 py-2 text-center text-white">
                  <Image
                    ...
                    alt="Black Casino Chip"
                  />{" "}
                  <span className="font-semibold">{ourBetThisStreet}</span>
                </div>
                <section className="relative mx-auto flex w-full max-w-[188px] justify-center gap-2 px-1 lg:max-w-[232px]">
                  {ourButton ? (
                    <div className="absolute -left-10 bottom-0 top-0 grid h-full items-center text-center">
                  ...
                  <div className="absolute inset-x-0 -bottom-1 flex h-12 flex-col justify-center rounded-xl bg-zinc-800 px-4 py-2 text-white">
                    <div className="flex">
                      ...
                      <span className="flex-1 text-center">${ourStack}</span>
                    </div>
                  </div>
                  <Image
                    className="max-w-[70px] lg:max-w-[100px]"
