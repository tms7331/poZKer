...
export default function Component() {
  ...
  const [holecard0SVG, setHolecard0SVG] = useState<string>(
    "/svg_playing_cards/backs/blue.svg",
  );
  const [holecard1SVG, setHolecard1SVG] = useState<string>(
    "/svg_playing_cards/backs/blue.svg",
  );
  const [boardcard0SVG, setBoardcard0SVG] = useState<string>(
    "/svg_playing_cards/backs/blue.svg",
  );
  const [boardcard1SVG, setBoardcard1SVG] = useState<string>(
    "/svg_playing_cards/backs/blue.svg",
  );
  const [boardcard2SVG, setBoardcard2SVG] = useState<string>(
    "/svg_playing_cards/backs/blue.svg",
  );
  const [boardcard3SVG, setBoardcard3SVG] = useState<string>(
    "/svg_playing_cards/backs/blue.svg",
  );
  const [boardcard4SVG, setBoardcard4SVG] = useState<string>(
    "/svg_playing_cards/backs/blue.svg",
  );
